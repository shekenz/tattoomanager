					...
					<table bgcolor="#fffae8" align="center" border="0" cellpadding="0" cellspacing="0" width="500px" style="border-collapse: collapse;" bgcolor="#ffffff">
						<tr id="header" bgcolor="#fffae8" align="center">
							<td style="padding-top: 50px; padding-bottom: 10px;">
								<img src="cid:christmascard" alt= "Heart Of Oak Tattoo Logo" style="display:block">
							</td>
						</tr>
						<tr>
							<td style="padding-left: 15px; padding-right: 15px;">
								<table>
									<tr>
										<td align="center">
											<h2 style="margin-bottom: 10px;margin-top: 50px;padding: 0px; font-size:24px;"><?= $title ?></h2>
										</td>
									</tr>
									<tr>
						...
						<tr id="footer">
							<td align="center">
								<table width="500px" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td align="center" style="padding-bottom: 10px; padding-left: 10px; padding-right: 10px; font-size: 10px; color:#999999"> </td>
									</tr>
								</table>
							</td>
						</tr>
