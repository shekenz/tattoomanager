...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'fd80d4349c60800783307f34c47e38cbfcd6089a8ed3881bab5683ffc4cea218'),
    ],
    ...
    'EmailTransport' => [
        ...
        'gmail' => [
            ...
            'port' => 465,
            'timeout' => 30,
            'username' => 'shekenztattoo@gmail.com',
            'password' => 'pl45t0r!zl4',
            'client' => null,
            'tls' => null,
            'url' => env('EMAIL_TRANSPORT_DEFAULT_URL', null),
        ]
    ...
    'Datasources' => [
        'default' => [
            ...
            'password' => 'rJ45tT69mX83',
            'database' => 'tattoomanager',
            /*
